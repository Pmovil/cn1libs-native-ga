...
var o = {};
    ...
    o.get__java_lang_String = function(param1, callback) {
        callback.error(new Error("Not implemented yet"));
    };

    o.set__java_lang_String_java_lang_String = function(param1, param2, callback) {
        callback.error(new Error("Not implemented yet"));
    };

    o.initialize__java_lang_String = function(param1, callback) {
        callback.error(new Error("Not implemented yet"));
    };
    ...
    o.setLocation__java_lang_String = function(param1, callback) {
        callback.error(new Error("Not implemented yet"));
    };
    ...
    o.setEncoding__java_lang_String = function(param1, callback) {
        callback.error(new Error("Not implemented yet"));
    };

    o.send__java_lang_String = function(param1, callback) {
        callback.error(new Error("Not implemented yet"));
    };

    o.setPage__java_lang_String = function(param1, callback) {
        callback.error(new Error("Not implemented yet"));
    };

    o.setAnonymizeIp__boolean = function(param1, callback) {
        callback.error(new Error("Not implemented yet"));
    };
...
exports.com_pmovil_nativega_impl_TrackerNativeInterface= o;
